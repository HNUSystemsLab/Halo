...
class key_generator_t {
 public:
   ...
   */
  key_generator_t(size_t N, size_t size);
...
class uniform_key_generator_t final : public key_generator_t {
 public:
  uniform_key_generator_t(size_t N, size_t size)
      : dist_(1, N), key_generator_t(N, size) {}
...
class selfsimilar_key_generator_t final : public key_generator_t {
 public:
  selfsimilar_key_generator_t(size_t N, size_t size, float skew = 0.2)
      : dist_(1, N, skew), key_generator_t(N, size) {}
...
class zipfian_key_generator_t final : public key_generator_t {
 public:
  zipfian_key_generator_t(size_t N, size_t size, float skew = 0.99)
      : dist_(1, N, skew), key_generator_t(N, size) {}
